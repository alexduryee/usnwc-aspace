# USNWC update - have the ObjectsController#index allow for sorting by digital_object_id
Rails.application.config.after_initialize do
  class ObjectsController < ApplicationController  
	def index
	    ...
	    # add digital_object_id sorting for USNWC
	    if params[:limit].eql?('digital_object') 
	      @sort_opts.push([I18n.t('search_sorting.sorting', :type => I18n.t("search_sorting.digital_object_id"), :direction => I18n.t("search_sorting.asc")), "digital_object_id asc"])

	      @sort_opts.push([I18n.t('search_sorting.sorting', :type => I18n.t("search_sorting.digital_object_id"), :direction => I18n.t("search_sorting.desc")), "digital_object_id desc"])
	    end
